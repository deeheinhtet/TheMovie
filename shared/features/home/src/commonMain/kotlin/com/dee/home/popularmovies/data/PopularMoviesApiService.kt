 ...
 */
class PopularMoviesApiService(private val httpClient: HttpClient) {

    suspend fun fetchPopularMovies(request: MovieListRequest? = MovieListRequest(page = 1)): NetworkResult<MovieListResponse> {
