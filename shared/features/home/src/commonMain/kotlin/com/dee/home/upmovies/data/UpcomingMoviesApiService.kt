 ...
 */
class UpcomingMoviesApiService(private val httpClient: HttpClient) {

    suspend fun fetchUpcomingMovies(request: MovieListRequest? = MovieListRequest(page = 1)): NetworkResult<MovieListResponse> {
