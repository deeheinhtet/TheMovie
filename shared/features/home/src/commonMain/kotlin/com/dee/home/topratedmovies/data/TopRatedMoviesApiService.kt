 ...
 */
class TopRatedMoviesApiService(private val httpClient: HttpClient) {

    suspend fun fetchTopRatedMovies(request: MovieListRequest? = MovieListRequest(page = 1)): NetworkResult<MovieListResponse> {
    ...
    companion object {
        const val PATH = "movie/top_rated"
    }
}